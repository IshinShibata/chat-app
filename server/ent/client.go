...
// QueryUsers queries the users edge of a ChatRoom.
func (c *ChatRoomClient) QueryUsers(cr *ChatRoom) *UserQuery {
...
type (
	hooks struct {
		ChatRoom, Message, User []ent.Hook
	}
	inters struct {
		ChatRoom, Message, User []ent.Interceptor
	}
)
